...
//    self.navigationController.navigationBar.barTintColor = [UIColor colorWithRed:(34/255.0) green:(34/255.0)  blue:(34/255.0) alpha:0.7];
...
//    self.navigationController.navigationBar.tintColor = [UIColor colorWithRed:(0x33/0xff) green:(0x33/0xff)  blue:(0x33/0xff) alpha:0.7];
}
...
- (void)configMoviePlayer {
    ...
    [[TZImageManager manager] getVideoWithAsset:_model.asset completion:^(AVPlayerItem *playerItem, NSDictionary *info) {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            [_cancelBtn setImage:[UIImage imageNamed:@"rg_editPic_back"] forState:UIControlStateNormal];
            _cancelBtn.frame = CGRectMake(12.f, StatusBarHeight, 44.f, 44.f);
