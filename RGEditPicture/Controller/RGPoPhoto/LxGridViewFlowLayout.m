...
CG_INLINE CGPoint CGPointOffset_Lx(CGPoint point, CGFloat dx, CGFloat dy)
{
...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            if (![sourceCollectionViewCell isKindOfClass:[RGAddCustomPicCell class]]) {
                return;
            }
            RGAddCustomPicCell *sourceCell = (RGAddCustomPicCell *)sourceCollectionViewCell;
            ...
            _beingMovedPromptView.height += 20;
...
- (void)panGestureRecognizerTriggerd:(UIPanGestureRecognizer *)pan
{
    switch (pan.state) {
        ...
        case UIGestureRecognizerStateChanged:
        {
            ...
            _beingMovedPromptView.center = CGPointOffset_Lx(_sourceItemCollectionViewCellCenter, panTranslation.x, panTranslation.y);
